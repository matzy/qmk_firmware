...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_tkl_f13_ansi_split_bs_rshift(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,             _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,C(KC_BSPC),C(KC_BSPC),_______, _______, _______,
        ...
        _______, C(KC_Z), _______, C(KC_C), KC_PGDN, KC_LEFT, KC_DOWN, KC_ENT , _______, _______, C(KC_Z),          _______, _______,                      _______,
    ...
    [3] = LAYOUT_tkl_f13_ansi_split_bs_rshift(
        ...
        _______, _______, _______, _______, KC_PGUP,C(KC_LEFT),A(KC_DOWN),_______,_______,_______,_______,          _______, _______,                      _______,
        _______, _______, _______,                            _______,                            _______, _______, _______, _______,             _______, _______, _______
    )
};
