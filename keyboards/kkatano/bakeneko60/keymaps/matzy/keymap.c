...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_60_tsangan_hhkb(
        ...
        KC_CAPS  , _______  , _______  , _______  , _______  , KC_MPLY  , _______  , _______  , KC_HOME  , KC_PGUP  , KC_LEFT  , KC_RGHT  ,            _______  ,
    ...
    [_FN2] = LAYOUT_60_tsangan_hhkb(
        ...
        _______  , _______  , C(KC_W)  , KC_END   , C(KC_I)  , _______  , C(KC_V)  , _______  , _______  ,C(KC_ENT) , KC_UP    , _______  , _______  , _______  ,
        ...
        QK_BOOT  , _______  ,MO(_FN3)  ,                                  _______  ,                                             _______  , _______  , _______
    ),
    ...
    [_FN3] = LAYOUT_60_tsangan_hhkb(
        ...
        _______  , _______  , _______  , C(KC_DEL),C(KC_RGHT), _______  ,C(KC_BSPC), _______  , _______  , _______  , _______  , _______  ,            _______  ,
