...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                                          MO(_FN1), KC_RALT, KC_RGUI, KC_RCTL
  ),
  ...
  [_FN1] = LAYOUT_all(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______, _______,         _______,
